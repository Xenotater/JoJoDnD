...
export default function ContentFilterModal(props: ContentFilterModalProps) {
  ...
  return (
    <Modal className="bg-[rgba(69,69,69,.25)] z-101" closeCallback={props.closer} fullPage>
      <div className="content flex flex-col justify-between min-h-[40vh] w-[90vw] lg:w-[65vw] max-h-[70vh] m-auto shadow-lg">
        <div>
