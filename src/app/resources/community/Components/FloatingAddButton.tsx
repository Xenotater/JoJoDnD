...
export default function FloatingAddButton() {
  ...
  return (
    <div className="right-0 w-0">
      ...
      <IconButton onClick={() => authExecute(auth, () => setModalOpen(!modalOpen))} className="sticky top-10 sm:top-20 p-0.5 ml-[-18px] sm:ml-[-25px] text-2xl sm:text-4xl bg-jj-purple-1 text-white">
        <BsPlus/>
      </IconButton>
      {modalOpen &&
