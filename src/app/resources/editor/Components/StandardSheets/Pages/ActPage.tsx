  ...
  return (
    <div className="w-[8.5in] h-[11in] border-2 bg-white p-[32px]">
      ...
      <div className="w-full grid grid-cols-12 gap-x-[24px] gap-y-2">
        ...
        <select className="col-span-4 mt-2 px-2 border-2 appearance-none" defaultValue="ability" value={data.act2Type} onChange={(e) => updateField("act2Type", e.target.value)} >
          <option value="close">{t("actClose")}</option>
          <option value="long">{t("actLong")}</option>
          <option value="ability">{t("actAbility")}</option>
          <option value="remote">{t("actRemote")}</option>
        ...
        <InputWrapper label={t("power")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act2-str-mod"]} onChange={(e) => updateField("act2-str-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act2-str-score"]} onChange={(e) => updateField("act2-str-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("precision")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act2-dex-mod"]} onChange={(e) => updateField("act2-dex-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act2-dex-score"]} onChange={(e) => updateField("act2-dex-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("durability")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act2-con-mod"]} onChange={(e) => updateField("act2-con-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act2-con-score"]} onChange={(e) => updateField("act2-con-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("range")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act2-int-mod"]} onChange={(e) => updateField("act2-int-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act2-int-score"]} onChange={(e) => updateField("act2-int-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("speed")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act2-wis-mod"]} onChange={(e) => updateField("act2-wis-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act2-wis-score"]} onChange={(e) => updateField("act2-wis-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("standEnergy")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act2-cha-mod"]} onChange={(e) => updateField("act2-cha-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act2-cha-score"]} onChange={(e) => updateField("act2-cha-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("abilities")} className="col-span-3 row-span-3 min-w-0">
          <textarea className={`${styles.bigInput} h-[202px] text-xs text-left leading-3 p-1 resize-none`} value={data.act3AbilityInfo} onChange={(e) => updateField("act3AbilityInfo", e.target.value)} />
        </InputWrapper>
        <div className="col-span-2">
          <h3 className="underline">{t("act3")}</h3>
        </div>
        <select className="col-span-4 mt-2 px-2 border-2 appearance-none" defaultValue="close" value={data.act3Type} onChange={(e) => updateField("act3Type", e.target.value)} >
          <option value="close">{t("actClose")}</option>
          <option value="long">{t("actLong")}</option>
          <option value="ability">{t("actAbility")}</option>
          <option value="remote">{t("actRemote")}</option>
        ...
        <InputWrapper label={t("power")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act3-str-mod"]} onChange={(e) => updateField("act3-str-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act3-str-score"]} onChange={(e) => updateField("act3-str-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("precision")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act3-dex-mod"]} onChange={(e) => updateField("act3-dex-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act3-dex-score"]} onChange={(e) => updateField("act3-dex-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("durability")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act3-con-mod"]} onChange={(e) => updateField("act3-con-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act3-con-score"]} onChange={(e) => updateField("act3-con-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("range")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act3-int-mod"]} onChange={(e) => updateField("act3-int-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act3-int-score"]} onChange={(e) => updateField("act3-int-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("speed")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act3-wis-mod"]} onChange={(e) => updateField("act3-wis-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act3-wis-score"]} onChange={(e) => updateField("act3-wis-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("standEnergy")} className="col-span-2 min-w-0">
          <ScalingInput className={`${styles.bigInput} h-[40px] text-[25px]`} fontmax={36} value={data["act3-cha-mod"]} onChange={(e) => updateField("act3-cha-mod", e.target.value)} />
          <ScalingInput className={`${styles.bigInput} border-t-0 h-[25px] text-[16px]`} fontmax={24} value={data["act3-cha-score"]} onChange={(e) => updateField("act3-cha-score", e.target.value)} />
        </InputWrapper>
        <InputWrapper label={t("abilities")} className="col-span-3 row-span-3 min-w-0">
        ...
        <select className="mt-2 px-2 border-2 appearance-none grow py-[2px]" value={data.act4Base} onChange={(e) => updateField("act4Base", e.target.value)} >
